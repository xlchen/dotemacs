...
(defun smart-insert-operator (op &optional only-back)
  ...
  (if (comint-within-quotes-2 0 (point))
	...
	(when (and (or op-p (not (and (bolp) (eolp))))
	  ...
	  (forward-char))
	(cond
	 ((and (or (equal op "/") (equal op ">")) (looking-back "^\\#include.*"))
	  (progn
	    (setq fir-sp nil)
	    (setq sec-sp nil)))
	 ((or (and (equal op "<") (looking-back "^#include.*")) (and (equal op "*") (looking-back "int\\|char\\|float\\|double\\|short\\|long\\|signed\\|unsigned\\|void")))
	  (setq sec-sp nil))
	 ((or (equal op ",") (and (equal op "=") op-p) (and (equal op "=") (looking-back "!")) (and (or (equal op "<") (equal op ">") (equal op "+") (equal op "-") (equal op "|") (equal op "&")) (looking-back op)))
	  (setq fir-sp nil))
	 ((or (and (equal op ">") (looking-back "-")) (and (equal op "*") (looking-back "/")) (and (equal op "/") (or (looking-back "*") (looking-back "/"))))
	  (progn
	    (setq fir-sp nil)
	    (setq sec-sp nil)
	    (backward-char)
